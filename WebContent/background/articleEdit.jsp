  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <select name="caid" id="caid">
	        <c:forEach var="catalog" items="${catalogs}">
	        	<c:choose>
	        		<c:when test="${article.getCaname() eq catalog.getCaname()}">
	        			<option value=${catalog.getCaid()} selected="selected" >&nbsp;&nbsp;${catalog.getCaname()}</option>
	        		</c:when>
	        		<c:otherwise>
	        			<option value=${catalog.getCaid()}  >&nbsp;&nbsp;${catalog.getCaname()}</option>
	        		</c:otherwise>
	        	</c:choose>
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="arnumber" disabled="disabled" value=${article.getArnumber()} class="text-word">
        <input type="hidden" name="arnumber" value=${article.getArnumber()} class="text-word">
        </td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <textarea rows="15" cols="50" name="arcontent"><%out.print(((Article)request.getAttribute("article")).getArcontent()); %></textarea>
        </td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">作者:</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="aruser" value=${article.getAruser()} class="text-word">
        </td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <select name="level" id="level">
		    <c:choose>
	        	<c:when test="${article.getArstate()==1}">
